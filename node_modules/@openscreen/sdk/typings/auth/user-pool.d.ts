...
export declare class UserPool {
    ...
    authenticate(key: string, secret: string): Promise<CognitoUserAsync | null>;
    signUp(email: string, password: string, attributes: any): Promise<import("amazon-cognito-identity-js").ISignUpResult>;
}
